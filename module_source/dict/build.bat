...
pyinstaller --noconsole --onedir --contents-directory "." description.py
    xcopy /y /e /i "C:\Users\Admin\AppData\Local\Programs\Python\Python311\Lib\site-packages\accessible_output3\lib" "dist\description\accessible_output3\lib"